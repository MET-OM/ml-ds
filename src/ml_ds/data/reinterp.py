...
reinterp_folder = "reinterp/"

# --- Year range ---
years = np.arange(1940, 2026)

# --- EC-Earth3 grid specification ---
ecearth_file = "EC-Earth3.grid.nc"
...
def process_year(year):
    ...
    ds = ds.interp(latitude=coarse_lat, longitude=coarse_lon, method='linear', kwargs={"fill_value":"extrapolate"})

    # Interpolate back to ERA5 grid (fine)
    ds = ds.interp(latitude=fine_lat, longitude=fine_lon, method='linear', kwargs={"fill_value":"extrapolate"})
